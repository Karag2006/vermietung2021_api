<tr>
    ...
    <td class="td-info td-info-left text-left txt-bold" colspan="3">{{ $document->vehicle_title ?? '' }}</td>
...
<tr>
    ...
    <td class="td-info td-info-left text-left txt-bold" colspan="3">{{ $document->vehicle_plateNumber ?? '' }}</td>
    <td class="text-left txt-bold txt-lg"></td>
    <td class="text-left txt-bold txt-lg pl"></td>
</tr>
<tr>
    <td class="text-left txt-bold txt-lg">Fahrgestellnummer:</td>
    <td class="td-info td-info-left text-left txt-bold" colspan="3">{{ $document->vehicle_chassisNumber ?? '' }}</td>
...
<tr>
    ...
    <td class="td-info td-info-left text-left txt-bold" colspan="3">{{ $document->vehicle_totalWeight ?? '' }}</td>
