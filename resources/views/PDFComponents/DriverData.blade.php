@if ($document->currentState == "contract")
    <tr>
        ...
        <td class="td-info">{{Str::upper($document->driver_driving_license_class ?? $document->customer_driving_license_class) }} &nbsp;	&nbsp;	&nbsp;	&nbsp;	| &nbsp;	&nbsp; {{ $document->driver_driving_license_no ?? $document->customer_driving_license_no }}</td>
    </tr>
    <tr>
